...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8,   CH2N,PB14, TIM_USE_MC_MOTOR  | TIM_USE_FW_SERVO,   1, 0), // S7
    DEF_TIM(TIM2,   CH1, PA15, TIM_USE_MC_SERVO  | TIM_USE_FW_SERVO,   1, 0), // S8
    DEF_TIM(TIM2,   CH3, PB10, TIM_USE_MC_SERVO  | TIM_USE_FW_SERVO,   1, 0), // S9
    DEF_TIM(TIM2,   CH4, PB11, TIM_USE_MC_SERVO  | TIM_USE_FW_SERVO,   1, 0), // S10
    DEF_TIM(TIM1,   CH3N,PB15, TIM_USE_MC_SERVO  | TIM_USE_FW_SERVO,   1, 0), // S11 
